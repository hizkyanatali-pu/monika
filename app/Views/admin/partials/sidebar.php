            ...
            <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon2-sort-down"></i><span class="kt-menu__link-text">Proges Keuangan & Fisik</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                    <ul class="kt-menu__subnav">
                        ...
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?= site_url('pulldata'); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Ditjen SDA</span></a></li>

                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?= site_url('pulldata/bbws'); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">BBWS</span></a></li>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?= site_url('pulldata/bws'); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">BWS</span></a></li>

                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?= site_url('pulldata/satkerpusat'); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Satker Pusat</span></a></li>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?= site_url('pulldata/satker'); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Satuan Kerja</span></a></li>

                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?= site_url('pulldata/skpdtpop'); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">SKPD TP OP</span></a></li>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?= site_url('pulldata/satkerpagu100m'); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Satker Pagu>100 M</span></a></li>
                    </ul>
                </div>
            </li>
            ...
            <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon2-sort-down"></i><span class="kt-menu__link-text">Postur Anggaran</span><span class="kt-badge kt-badge--danger">N</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                    <ul class="kt-menu__subnav">
                        ...
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?= site_url('posturanggaran/pohon-anggaran-dipa'); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Pohon Anggaran DIPA</span></a></li>
                        ...
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?= site_url('posturanggaran/sisa-belum-lelang'); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Belum Lelang</span></a></li>
