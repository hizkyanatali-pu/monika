...
<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
    ...
    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
        ...
        <ul class="kt-menu__nav ">
            ...
            <li class="kt-menu__item  kt-menu__item--submenu <?=
                ...
                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                    <ul class="kt-menu__subnav">
                        <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span class="kt-menu__link"><span class="kt-menu__link-text">123Proges Keuangan & Fisik</span></span></li>
            ...
            <li class="kt-menu__item  kt-menu__item--submenu <?=
                ...
                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                    <ul class="kt-menu__subnav">
                        ...
                        <li class="kt-menu__item <?= ($request->uri->getSegment(1) == 'posturanggaran' && $request->uri->getSegment(2) == 'alokasi-anggaran-new'  ? ' kt-menu__item--active' : '') ?>" aria-haspopup="true">
                            <a href="<?= site_url('posturanggaran/alokasi-anggaran-new'); ?>" class="kt-menu__link ">
                                <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                        ...
                        <li class="kt-menu__item <?=
                                                    ($request->uri->getSegment(1) == 'posturanggaran' && $request->uri->getSegment(2) == 'rencana-tender'  ? ' kt-menu__item--active' : '') ?>" aria-haspopup="true"><a href="<?= site_url('posturanggaran/rencana-tender'); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Rencana Tender</span></a></li>
                        <li class="kt-menu__item <?=
            ...
            <li class="kt-menu__item  <?= ($request->uri->getSegment(1) == 'tematik' ? ' kt-menu__item--active' : '') ?>" aria-haspopup="true">
                <a href="<?= site_url('tematik'); ?>" class="kt-menu__link ">
            ...
            <li class="kt-menu__item  <?= ($request->uri->getSegment(1) == 'blokir' ? ' kt-menu__item--active' : '') ?>" aria-haspopup="true">
            ...
            <li class="kt-menu__item  kt-menu__item--submenu <?= ($request->uri->getSegment(1) == 'master-data' ? ' kt-menu__item--open kt-menu__item--here' : '') ?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                ...
                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                    <ul class="kt-menu__subnav">
                        <li class="kt-menu__item <?= ($request->uri->getSegment(1) == 'master-data' && $request->uri->getSegment(2) == 'master-satker'  ? ' kt-menu__item--active' : '') ?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item <?= ($request->uri->getSegment(1) == 'master-data' && $request->uri->getSegment(2) == 'master-kegiatan'  ? ' kt-menu__item--active' : '') ?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item <?= ($request->uri->getSegment(1) == 'master-data' && $request->uri->getSegment(2) == 'master-kro'  ? ' kt-menu__item--active' : '') ?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item <?= ($request->uri->getSegment(1) == 'master-data' && $request->uri->getSegment(2) == 'master-ro'  ? ' kt-menu__item--active' : '') ?>" aria-haspopup="true">
                ...
                <div class="kt-menu__submenu ">
                    ...
                    <ul class="kt-menu__subnav">
                        ...
                        <li class="
                            ...
                            <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                                <i class="kt-menu__link-icon fas fa-book"></i>
                                <span class="kt-menu__link-text">Data Renstra</span>
                                <i class="kt-menu__ver-arrow la la-angle-right"></i>
                            </a>
                            ...
                            <div class="kt-menu__submenu ">
                                ...
                                <ul class="kt-menu__subnav">
                                    ...
                                    <li class="kt-menu__item  <?= ($request->uri->getSegment(1) == 'renstra' && $request->uri->getSegment(2) == 'eselon2'  ? ' kt-menu__item--active' : '') ?>" aria-haspopup="true">
                                        <a href="<?= site_url('renstra/eselon2'); ?>" class="kt-menu__link ">
                                            <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                                                <span></span>
                                            </i>
                                            <span class="kt-menu__link-text">
                                    ...
                                    <li class="kt-menu__item  <?= ($request->uri->getSegment(1) == 'renstra' && $request->uri->getSegment(2) == 'eselon1'  ? ' kt-menu__item--active' : '') ?>" aria-haspopup="true">
                                        <a href="<?= site_url('renstra/eselon1'); ?>" class="kt-menu__link ">
                                            <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                                                <span></span>
                                            </i>
                                            <span class="kt-menu__link-text">
                                    ...
                                    <li class="kt-menu__item  <?= ($request->uri->getSegment(1) == 'renstra' && $request->uri->getSegment(2) == 'rekapitulasi'  ? ' kt-menu__item--active' : '') ?>" aria-haspopup="true">
                                        <a href="<?= site_url('renstra/rekapitulasi'); ?>" class="kt-menu__link ">
                                            <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                                                <span></span>
                                            </i>
                                            <span class="kt-menu__link-text">
