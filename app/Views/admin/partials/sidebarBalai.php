...
<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
        <ul class="kt-menu__nav ">
            <li class="kt-menu__item  kt-menu__item--submenu <?= ($request->uri->getSegment(1) == 'dokumenpk' || $request->uri->getSegment(1) == 'dokumenpk-balai-satker'  ? ' kt-menu__item--open kt-menu__item--here' : '') ?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                ...
                <div class="kt-menu__submenu ">
                    ...
                    <ul class="kt-menu__subnav">
                        ...
                        <li class="kt-menu__item <?= ($request->uri->getSegment(1) == 'dokumenpk-balai-satker' ? ' kt-menu__item--active' : '') ?>" aria-haspopup="true">
            ...
            <li class="kt-menu__item  kt-menu__item--submenu <?= ($request->uri->getSegment(1) == 'renstra' || $request->uri->getSegment(1) == 'dokume-renstra-balai-satker'  ? ' kt-menu__item--open kt-menu__item--here' : '') ?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                    <i class="kt-menu__link-icon fas fa-book"></i>
                    <span class="kt-menu__link-text">Rencana Strategis</span>
                    <i class="kt-menu__ver-arrow la la-angle-right"></i>
                </a>
                ...
                <div class="kt-menu__submenu ">
                    ...
                    <ul class="kt-menu__subnav">
                        <li class="kt-menu__item <?= ($request->uri->getSegment(1) == 'renstra' ? ' kt-menu__item--active' : '') ?>" aria-haspopup="true">
                            <a href="<?= site_url('renstra-balai-satker/all'); ?>" class="kt-menu__link ">
                                <i class="kt-menu__link-icon fas fa-book"></i>
                                <span class="kt-menu__link-text">Rencana Strategis Satker</span>
                            </a>
                        </li>
