            ...
            <div class="kt-section">
                ...
                <div class="card py-5 px-4">
                    <div class="row icon-row">
                        <div class="col-sm-4 col-xl-3 icon-group" data-toggle="modal" data-target="#dashboard1Modal">
                            <br>
                            <span class="icon">
                        ...
                        <div class="col-sm-4 col-xl-3 icon-group" data-toggle="modal" data-target="#dashboard2Modal">
                            <br>
                            <span class="icon">
                        ...
                        <div class="col-sm-4 col-xl-3 icon-group" data-toggle="modal" data-target="#dashboard3Modal">
                            <br>
                            <span class="icon">
                                <i class="fas fa-file-invoice-dollar fa-2x"></i>
                            </span>
                            <p>Progres Kegiatan Tematik Direktorat Jendral Sumber Daya Air T.A.<?= session('userData.tahun') ?></p>
                        </div>
                        <div class="col-sm-4 col-xl-3 icon-group" data-toggle="modal" data-target="#dashboard4Modal">
                            <br>
                            <span class="icon">
                                <i class="fas fa-box fa-2x"></i>
                            </span>
                            <p>Postur Paket Kontraktual T.A. <?= session('userData.tahun') ?></p>
                        </div>
                        <div class="col-sm-4 col-xl-3 icon-group" data-toggle="modal" data-target="#dashboard5Modal">
                            <br>
                            <span class="icon">
                                <i class="fas fa-file-invoice-dollar fa-2x"></i>
                            </span>
                            <p>Postur Paket Belum Lelang TA <?= session('userData.tahun') ?></p>
                        </div>
                        <div class="col-sm-4 col-xl-3 icon-group" data-toggle="modal" data-target="#dashboard6Modal">
                            <br>
                            <span class="icon">
                                <i class="fas fa-file-invoice-dollar fa-2x"></i>
                            </span>
                        ...
                        <div class="col-sm-4 col-xl-3 icon-group" data-toggle="modal" data-target="#dashboard7Modal">
                            <br>
                            <span class="icon">
                        ...
                        <div class="col-sm-4 col-xl-3 icon-group" data-toggle="modal" data-target="#dashboard8Modal">
                            <br>
                            <span class="icon">
                                <i class="fas fa-calculator fa-2x"></i>
                            </span>
                ...
                <div class="card mt-5">
                    ...
                    <div class="row icon-row2">
                        <div class="col-sm-6 col-xl-3 icon-group2" data-toggle="modal" data-target="#dashboard9Modal">
                            <div>
                                <span class="icon">
                        ...
                        <div class="col-sm-6 col-xl-3 icon-group2" data-toggle="modal" data-target="#dashboard10Modal">
                            <div>
                                <span class="icon">
                                    <i class="fas fa-water fa-4x"></i>
                                </span>
                        ...
                        ?>
                        <div class="col-sm-6 col-xl-3 icon-group2" data-toggle="modal" data-target="#dashboard<?= $no_modal ?>Modal">
                            <div>
                                <span class="icon">
                                    <i class="fas fa-water fa-4x"></i>
                                </span>
                                <?php if ($key1 != "Semua Satker") { ?>
                                    <p><?= strtoupper($key1) ?></p>
                                <?php } else { ?>
                                    <p>PROGRES 10 SATUAN KERJA TERENDAH TA <?= session('userData.tahun') ?></p>
                                <?php  } ?>
                            </div>
                        </div>
                        <?php 
