                                        ...
                                        <table class="table table-bordered mb-0" style="">
                                            <thead>
                                                ...
                                                <tr style="background-color: #facaac;">
                                                    ...
                                                    <th style="border: 2px solid #c88a5b;"><b> ? </b></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td style="border: 2px solid #c88a5b;">RPM</td>
                                                    <td style="border: 2px solid #c88a5b;"><b> ? </b></td>
                                                </tr>
                                                <tr>
                                        ...
                                        <table class="table table-bordered mb-0" style="">
                                            <thead>
                                                ...
                                                <tr style="background-color: #f1f1f1;">
                                                    ...
                                                    <th style="border: 2px solid #e5e5e5;"><b> ? </b></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td style="border: 2px solid #e5e5e5;">RPM</td>
                                                    <td style="border: 2px solid #e5e5e5;"><b> ? </b></td>
                                                </tr>
                                                <tr>
                                        ...
                                        <table class="table table-bordered mb-0" style="">
                                            <thead>
                                                ...
                                                <tr style="background-color: #7DC5D3;">
                                                    ...
                                                    <th style="border: 2px solid #74ACB9;"><b> ? </b></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td style="border: 2px solid #74ACB9;">RPM</td>
                                                    <td style="border: 2px solid #74ACB9;"><b> ? </b></td>
                                                </tr>
                                                <tr>
                                        ...
                                        <table class="table table-bordered mb-0" style="">
                                            <thead>
                                                ...
                                                <tr style="background-color: #D9D9D9;">
                                                    ...
                                                    <th style="border: 2px solid #7E7E7E;"><b> ? </b></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td style="border: 2px solid #7E7E7E;">RPM</td>
                                                    <td style="border: 2px solid #7E7E7E;"><b> ? </b></td>
                                                </tr>
                                                <tr>
