        ...
        <ol class="organizational-chart">
            <li>
                ...
                <ol>
                    <li>
                        <div>
                            <h2>PROGRAM <br> KETAHANAN SDA</h2>
                            <hr>
                    ...
                    <li>
                        <div>
                            <h2>PROGRAM <br> DUKUNGAN MANAJEMEN</h2>
                            <hr>
                        ...
                        <ol>
                            ...
                            <li>
                                <div>
                                    <h3>LAYANAN <br> PERKANTORAN DAN <br> SARANA PRASARANA</h3>
                                    <hr>
                                    RP. <?= number_format($layananperkantoran->total / 1000, 0, ',', '.'); ?> <br>
