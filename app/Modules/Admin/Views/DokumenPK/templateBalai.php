                            ...
                            <div class="d-flex justify-content-end" style="margin-top: -14px">
                                <div class="dropdown show">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        <a class="dropdown-item _add-form-row" data-type="section_title">Sasaran Program</a>
...
<script>
    ...
    $('button[name=update-document]').click(function() {
        ...
        if (formValidation()) {
            ...
            // console.log(form.getAll('formTable_idRow[]'));
            // return false;
    ...
    function render_rowForm(params = {
        ...
        return `
            <tr class="_row-form" draggable="true">
                ...
                <td class="d-none _col-form" draggable="true" style="position: relative">
