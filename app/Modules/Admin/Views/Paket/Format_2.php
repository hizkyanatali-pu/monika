        ...
        <div class="kt-portlet__body" style="padding:0px;">
            ...
            <div class="kt-section">
                <div class="bg-white rounded box-shadow">
                    ...
                    <h6 class="border-bottom border-gray pb-2 mb-0"><a id="a-go-pagu" data-toggle="collapse" href="#go-pagu" aria-expanded="true" aria-controls="go-pagu">Progres Keuangan dan Fisik SDA <i class="fa fa-angle-double-down"></i></a></h6>
                                    ...
                                    foreach ($qdata as $key => $data) : ?>
                                        ...
                                        <tr class="stw<?= $data['stw']; ?>">
                                            <td class="tdKodeLabel">
                                                <a href="<?php echo site_url('pulldata/' . $nextlink . '/' . ($idk ? $idk . '/' : '') . $data['id']); ?>/<?php echo $label; ?>/<?php echo $data['label']; ?>"><?php echo $data['label']; ?></a>
                                            </td>
