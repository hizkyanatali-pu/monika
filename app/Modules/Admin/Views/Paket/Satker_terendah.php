                        ...
                        <table class="table-bordered mb-0 table-striped" width="100%">
                            <thead class="text-center text-white" style="background-color: #1562aa;">
                                <tr class="text-center">
                                    ...
                                    <th class="paket">&nbsp;</th>
                                    <?= ($key1 == 'Satker Terendah' ?    '<th class="satker_">&nbsp;</th>' : '') ?>
                                    <th class="pagu-main" colspan="<?= ($key1 == 'Satker Terendah' ? "4" : "5") ?>">Pagu (Rp)</th>
                                    <?= ($key1 == 'Satker Terendah' ?    ' <th class="pagu-main" colspan="4">Realisasi (Rp)</th>' : '') ?>
                                    <th class="progres" colspan="2">Progres (%)</th>
                                    <th class="deviasi" colspan="2">Deviasi</th>
                                </tr>
                                <tr class="text-center">
                                    <th class="unit_kerja"><?= $key1; ?></th>
                                    <?= ($key1 == 'Satker Terendah' ?    '<th class="satker_">Satker</th>' : '') ?>
                                ...
                                <?php if ($progfis) : ?>
                                    ...
                                    foreach ($progfis as $key => $data) : ?>
                                        ...
                                        <tr class="stw<?= $data['stw']; ?>">
                                            ...
                                            <?= ($key1 == 'Satker Terendah' ? '<td class="tdNilai text-center col-paket">' . $data['st'] . '</td>' : '') ?>
