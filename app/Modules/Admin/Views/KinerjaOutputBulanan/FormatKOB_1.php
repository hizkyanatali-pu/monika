                ...
                <div class="kt-section__content">
                    <div class="table-responsive tableFixHead1">
                        ...
                        <table class="table table-bordered table-striped" id="table">
                            <thead>
                                <tr>
                                    <th class="" colspan="<?= $colspan; ?>" style="border:0px;">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-2 col-form-label">Pilih Bulan</label>
                                            <div class="col-2">
                                    ...
                                    <th class="text-right text-danger" colspan="5" style="border:1px;">
