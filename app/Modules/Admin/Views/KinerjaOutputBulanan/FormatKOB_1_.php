                            ...
                            <?php if ($qdata) : ?>
                                ...
                                <?php foreach ($nArraysoutput as $key => $d) :    ?>
                                    ...
                                    <?php if (!in_array($idk, $idp)) :
                                        ...
                                        $pg_program = gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'programpg');
                                        $realisasi_program = gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'programrealisasi', ($bulanberjalan == $bulansekarang ?  'pkt.rtot'  : 'rr_b' . $bulanberjalan));
                                        $keu_rn_program = gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'programkeu_rn','pkt.renk_b' . $bulanberjalan);
                                        $keu_rl_program = gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'programkeu_rl', ($bulanberjalan == $bulansekarang ?  'pkt.rtot'  : 'rr_b' . $bulanberjalan));
                                        $fis_rn_program = gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'programfis_rn', 'pkt.renf_b' . $bulanberjalan);
                                        $fis_rl_program =  gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'programfis_rl', ($bulanberjalan == $bulansekarang ?  'pkt.ufis'  : 'pkt.ff_b' . $bulanberjalan));
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="tdprogram" style="text-align: right;"><?= '<b>' .   str_replace('.', ',', round(gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'programvol'), 2))  . '</b>' ?></td>
                                    ...
                                    <?php if (!in_array($idk, $ido)) :
                                        ...
                                        $pg_giat = gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'kegiatanpg');
                                        $realisasi_giat = gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'kegiatanrealisasi', ($bulanberjalan == $bulansekarang ?  'pkt.rtot'  : 'rr_b' . $bulanberjalan));
                                        $keu_rn_giat = gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'kegiatankeu_rn', 'pkt.renk_b' . $bulanberjalan);
                                        $keu_rl_giat = gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'kegiatankeu_rl', ($bulanberjalan == $bulansekarang ?  'pkt.rtot'  : 'rr_b' . $bulanberjalan));
                                        $fis_rn_giat = gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'kegiatanfis_rn', 'pkt.renf_b' . $bulanberjalan);
                                        $fis_rl_giat =  gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'kegiatanfis_rl', ($bulanberjalan == $bulansekarang ?  'pkt.ufis'  : 'pkt.ff_b' . $bulanberjalan));
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="tdgiat" style="text-align: right"><?= '<b>' . str_replace('.', ',', round(gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'kegiatanvol'), 2))  . '</b>' ?></td>
                                    ...
                                    <?php if (!in_array($idk, $ido)) :
                                        $pg_output = gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'outputpg');
                                        $realisasi_output = gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'outputrealisasi', ($bulanberjalan == $bulansekarang ?  'pkt.rtot'  : 'rr_b' . $bulanberjalan));
                                        $keu_rn = gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'outputkeu_rn', 'pkt.renk_b' . $bulanberjalan);
                                        $keu_rl = gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'outputkeu_rl', ($bulanberjalan == $bulansekarang ?  'pkt.rtot'  : 'rr_b' . $bulanberjalan));
                                        $fis_rn = gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'outputfis_rn', 'pkt.renf_b' . $bulanberjalan);
                                        $fis_rl =  gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'outputfis_rl', ($bulanberjalan == $bulansekarang ?  'pkt.ufis'  : 'pkt.ff_b' . $bulanberjalan));
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="tdoutput" style="text-align: right"><?= '<b>' . str_replace('.', ',', round(gettotal($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], 'outputvol'), 2)) . '</b>' ?></td>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="tdsoutput"><?= '<b>' . getoutputname($dbuse, $d['kdprogram'], $d['kdgiat'], $d['kdoutput'], $d['kdsoutput']) . '</b>' ?></td>
