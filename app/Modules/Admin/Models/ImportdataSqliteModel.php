...
class ImportdataSqliteModel extends Model
{
    ...
    protected $allowedFields = ['idpull', 'nmfile', 'nmfileoriginal', 'sizefile', 'tbl_nm', 'tbl_size', 'tbl_row', 'tbl_dt', 'tbl_uid', 'st', 'import_dt', 'import_uid', 'aktif_dt', 'aktif_uid', 'in_dt', 'in_uid', 'aksi', 'tahun'];
